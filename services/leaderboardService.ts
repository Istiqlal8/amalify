...
export type BoardRow = { userId: string; name: string; avatarUrl: string | null; pages: number };

type Row = { user_id: string; display_name: string; avatar_url: string | null; pages: number };
